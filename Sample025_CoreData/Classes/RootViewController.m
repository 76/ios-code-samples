...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *addButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(addNewEvent)];
    self.navigationItem.rightBarButtonItem = addButton;
    [addButton release];
	
	UITabBarItem *tabItem = [[UITabBarItem alloc] initWithTitle:@"Events" image:[UIImage imageNamed:@"calendar"] tag:0];
...
- (void)addNewEvent {
	...
	EventDetailViewController *vc = [[EventDetailViewController alloc] initWithNibName:@"EventDetailViewController" bundle:[NSBundle mainBundle]];
	vc.event = event;
